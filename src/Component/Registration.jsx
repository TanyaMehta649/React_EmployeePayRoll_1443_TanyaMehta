      ...
      <div>
        ...
        <main className="flex flex-col items-center w-full min-h-screen">
          <div className="w-full bg-gray-100 !p-8 flex-1 justify-center items-center">
            <form
              className="items-center max-w-4xl mx-auto  !p-4 flex flex-col gap-[15px] text-[#42515F]"
              id="employeeForm"
            >
              ...
              <div className="min-w-[80%] flex flex-col gap-5 !m-[15px] max-[525px]:w-[100%] max-[525px]:!m-0">
                <div className="flex gap-4 flex-col md:flex-row">
                  <label
                    htmlFor="name"
                    className="min-w-[20%] text-left md:text-left text-[#42515F] font-normal"
                  >
                    Name
                  </label>
        ...
        hover:border-blue-300"
                ...
                <div className="flex  gap-2 flex-col md:flex-row">
                  <label htmlFor='profileImage' className="min-w-[20%] flex justify-start  text-left md:text-right font-normal text-[#42515F]">
                    Profile Image
                  </label>
          ...
          ${profileImage === img.value ? 'border-blue-500' : 'border-transparent'}"
                ...
                <div className="flex gap-4 md:flex-row flex-col">
                  <div className="min-w-[20%] text-[#42515F] font-normal">
                ...
                <div className="flex gap-2 flex-col md:flex-row">
                  <label htmlFor='department' className="flex justify-start min-w-[20%] text-left md:text-right font-normal text-[#42515F]">
                    Department
                  </label>
                ...
                <div className="flex gap-2 md:flex-row flex-col">
                  <label htmlFor="salary" className="min-w-[20%] font-normal text-[#42515F]">Select Salary</label>
                ...
                <div className="flex items-center gap-2 md:flex-row flex-col">
                  <label htmlFor='date' className="min-w-[20%] font-normal text-[#42515F]">Start Date</label>
                ...
                <div className="flex gap-2 md:flex-row flex-col">
                  <label className="min-w-[20%] font-normal text-[#42515F]" htmlFor="notes">Notes</label>
                  <textarea
                    id="notes"
                    name="notes"
                    value={notes}
